...
var StorageService = /** @class */ (function () {
    function StorageService(platformId, cookieManagerService) {
        this.platformId = platformId;
        this.cookieManagerService = cookieManagerService;
    }
    StorageService.prototype.storeString = function (key, value) {
    ...
    StorageService.prototype.hasKey = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!common_1.isPlatformBrowser(this.platformId)) return [3 /*break*/, 2];
                        return [4 /*yield*/, localforage.getItem(key)];
                    case 1:
                        _a = !!(_b.sent());
                        return [3 /*break*/, 3];
                    case 2:
                        _a = this.cookieManagerService.hasKey(key);
                        _b.label = 3;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [2 /*return*/, retValue];
                }
            });
        });
    };
